...
if(array_search($extensao, $_UP['extensoes']) === false){		
    ...
    if(move_uploaded_file($_FILES['imagem']['tmp_name'], $_UP['pasta']. $nome_final)){
        ...
        $comandoSql1="insert into tb_noticias(titulo_noticias, descricao_noticias, autor_noticias, link_noticias, img_noticias)values('$titulo','$descricao','$autor','$link','$nome_final')";
        echo "
        ...
        echo "
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/Teen_Invest1/paginas/noticias.php'>
            <script type=\"text/javascript\">
