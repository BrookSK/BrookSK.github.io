...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>Teen Invest | Perguntas Frequentes</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 m-auto">
				<!-- Page Title -->
				<h1>Principais perguntas e respostas para quem está começando em ações</h1>
				<!-- Page Description -->
				<p>Separamos abaixo algumas perguntas e respostas que te ajudarão a entender melhor o mundo das ações.</p>
			</div>
		</div>
	</div>
</section>
						...
						<div id="gstAccordion" data-children=".item">
						  ...
						  <div class="item">
						    ...
						    <div id="accountAccordion1" class="collapse accordion-block">
						      <p>
                                Comprar uma ação na XP é muito simples. O primeiro passo é você abrir gratuitamente uma conta clicando aqui . Feito isso, basta escolher uma de nossas plataformas de negociação, nas quais você terá acesso a todas as ações negociadas no Brasil, podendo comprá-las e vendê-las de forma muito simples.
						      </p>
						    </div>
						  </div>
                          <!-- Accordion Item 03 -->
